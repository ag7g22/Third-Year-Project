<template>
    <div class="container">
      ...
      <div class="buttons">
        ...
        <button @click="navigate('dailyquiz')">Daily Training</button>
        <button @click="navigate('lobby')">Versus</button>
        <button @click="navigate('categoryquiz')">Category Practice</button>
        <button @click="navigate('roadsignquiz')">Road Sign Practice</button>
        <button @click="navigate('hazard')">Hazard Perception</button>
