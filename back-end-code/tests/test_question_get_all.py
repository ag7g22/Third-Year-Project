...
class test_question_get_all(unittest.TestCase):
    """
    This test set focuses on testing the responses from the server on the test_question_get_all function.
    """
    # URLS to test on
    LOCAL_DEV_URL = "http://localhost:7071/question/get/all"
    PUBLIC_URL = "https://driving-theory.azurewebsites.net/question/get/all"
